...
%%like the basic idea of kmeans method, the aim of this sp_cluster method is to
%%assign the points to the specified cluster by stated cluster centers, in
%%which the number of clusters are subject to the center size
data = pop;
